...
if st.button("View results"):
    ...
    if datasize["g of CO2"] <= 0.0118660751670599:
        image = Image.open('/Users/ohseungyeon/Documents/streamlit/A+.png')
        ...
        image = Image.open('/Users/ohseungyeon/Documents/streamlit/B.png')
        resized_image = image.resize((100, 100))
        st.image(resized_image, use_column_width=True)
        st.write("g of CO2: " ,datasize["g of CO2"])
    elif datasize["g of CO2"] <= 2.35371515683271:
        image = Image.open('/Users/ohseungyeon/Documents/streamlit/C.png')
        resized_image = image.resize((100, 100))
        st.image(resized_image, use_column_width=True)
        st.write("g of CO2: " ,datasize["g of CO2"])
    elif datasize["g of CO2"] <= 6.5946437755711385:
        image = Image.open('/Users/ohseungyeon/Documents/streamlit/D.png')
        resized_image = image.resize((100, 100))
        st.image(resized_image, use_column_width=True)
        st.write("g of CO2: " ,datasize["g of CO2"])
    else:
        image = Image.open('/Users/ohseungyeon/Documents/streamlit/F.png')
        resized_image = image.resize((100, 100))
        st.image(resized_image, use_column_width=True)
        st.write("g of CO2: " ,datasize["g of CO2"])
